...
def main(config):
    ...
    for i in range(config.k):
        ...
        config.model_path = ('/%s/The%1d' % (config.model_type, i + 1))
        ...
        config.train_result_path = ('/train_result/%s/The%1d' % (config.model_type, i + 1))
        ...
        config.val_result_path = ('/val_result/%s/The%1d' % (config.model_type, i + 1))
...
if __name__ == '__main__':
    ...
    parser.add_argument('--train_result_path', type=str, default='/train_result/')
    parser.add_argument('--val_result_path', type=str, default='/val_result/')
    parser.add_argument('--test_result_path', type=str, default='/test_result/')
